...
public class Windows extends Computer{
    ...
    public Windows(String versionOS, String key, String cpuName, String motherBoard,
                   double memory, boolean hasKeyboard, boolean hasScreen,
                   boolean hasPaint, boolean hasViruses) {
