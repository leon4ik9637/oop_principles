...
public class Mac extends Computer{
    ...
    public Mac(String versionOS, String key, String cpuName, String motherBoard,
               double memory, boolean hasKeyboard, boolean hasScreen, boolean hasGarbageMagicMouse) {
